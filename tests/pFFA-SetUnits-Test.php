...
class SetUnitsTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testSetUnits_validate_options_pass()
    {
        ...
        foreach($valid_options as $valid_option) {
            $pFFA = new mmerlijn\phpFITFileAnalysis($this->base_dir . $this->filename, ['units' => $valid_option]);
    ...
    {
        $pFFA = new mmerlijn\phpFITFileAnalysis($this->base_dir . $this->filename, ['units' => 'INVALID']);
    }
    ...
    public function testSetUnits_validate_pace_option_pass()
    {
        ...
        foreach($valid_options as $valid_option) {
            $pFFA = new mmerlijn\phpFITFileAnalysis($this->base_dir . $this->filename, ['units' => 'raw', 'pace' => $valid_option]);
